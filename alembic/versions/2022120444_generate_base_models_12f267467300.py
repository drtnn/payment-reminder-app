...
Revision ID: 12f267467300
Revises: 
Create Date: 2022-12-04 11:44:11.002868
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("repeat", sa.String(length=7), nullable=True),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_index(
        op.f("ix_inter_user_payment_id"), "inter_user_payment", ["id"], unique=False
    )
    op.create_index(
...
def downgrade():
    ...
    op.drop_index(op.f("ix_inter_user_payment_id"), table_name="inter_user_payment")
